                ...
                <div className='row align-items-center h-100'>
                 <div className="mx-auto mb-auto">
                  ...
                  <div className='text-center'>
                    <h5><b>forget password?</b></h5>
                  </div>
                  
                  <InputText id={email} onChange={(e: ChangeEvent<HTMLInputElement>)=>
                    ...
                    <span>
                      A message was sent to your email address,
                      please check your email.
                    </span>
                  </div>)}
                  <div className="row pt-4">
                    <div className="col-md-6 d-flex justify-content-around"><button className='btn btn-light w-75' onClick={back}>Back</button></div>
                    <div className="col-md-6 d-flex justify-content-around"><button className='btn btn-warning w-75' onClick={submit}>Submit</button></div>
                  </div>
                 </div>
                </div>
              </div>
